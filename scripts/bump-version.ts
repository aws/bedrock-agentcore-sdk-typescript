...
/**
 * Version bump script for Bedrock AgentCore SDK
 *
 * Usage:
...
function parseVersion(version: string): ParsedVersion {
  // Match versions like: 1.2.3, 1.2.3-beta.1, 1.2.3-rc.0
...
function bumpVersion(current: string, bumpType: BumpType, prereleaseTag: string = 'beta'): string {
  ...
  switch (bumpType) {
    ...
    case 'patch':
      // If currently a prerelease, just remove the prerelease tag
